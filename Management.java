...
//    Car vt4 = new Car("Mazda", "Custom Plate", "White", VehicleType.Family, Gear.Automatic, CarType.SUV);
    ...
    void hireTest3() {
        ...
        Employee Serge = new Manager("Serge", 1985, 30, 4);
        Employee Cindy = new Manager("Cindy", 1974, 20, 6, 80);
        Employee Paul = new Programmer("Paul", 1993, 3, 75);
        Employee Pierre = new Tester("Pierre", 1987, 124, 50);
        Employee Matt = new Programmer("Matt", 1981, 5, 110);
        Employee Sarah = new Programmer("Sarah", 1986, 3);
